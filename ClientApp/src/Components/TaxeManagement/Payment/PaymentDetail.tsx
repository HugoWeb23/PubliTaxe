    ...
    return <>
        ...
        <Container fluid="xl">
            ...
            {value.user && value.user.role > 1 && <div className="d-flex justify-content-end mt-4 mb-4">
                <Button size="sm" variant="success" disabled={details.entreprise.recu === false && details.entreprise.proces_verbal !== true} onClick={() => setPaymentModal({ show: true, type: 'create' })}><PlusIcon /> Nouveau paiement</Button>
            </div>}
            <Table>
                <thead>
                    <tr>
